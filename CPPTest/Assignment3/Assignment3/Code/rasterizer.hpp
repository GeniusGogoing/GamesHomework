...
namespace rst
{
    ...
    private:
        ...
        Eigen::Vector3f interpolate3D(float alpha, float beta, float gamma, const std::array<Vector4f, 3> v, const Eigen::Vector3f& c0, const Eigen::Vector3f& c1, const Eigen::Vector3f& c2, float w_reciprocal);
        Eigen::Vector2f interpolate2D(float alpha, float beta, float gamma, const std::array<Vector4f, 3> v, const Eigen::Vector2f& c0, const Eigen::Vector2f& c1, const Eigen::Vector2f& c2, float w_reciprocal);
